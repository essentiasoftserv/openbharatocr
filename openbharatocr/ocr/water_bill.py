...
def water_bill(image_path):
    """Extracts information from a water bill image
    Args:
        image_path (str): Path to the water bill image.
    Returns:
    ...
    preprocessed_image = preprocess_for_bold_text(image)

    # Extract text using pytesseract OCR
    extracted_text = pytesseract.image_to_string(preprocessed_image)

    # Use all extraction functions
    ...
    id_number = extract_id_number(extracted_text)
