...
class test_extract_address(TestCase):
    ...
    def test_extract_address_standard(self):
        ...
        assert extracted_address == 'Send the package to 123 Pratap market, Jabalpur, IL 485002'

    def test_extract_address_multiple_street_names(self):
        # Test extracting an address with multiple street names
        text = "The meeting is at 456 Vijan Bussiness Hotel, Jabalpur, WA 482005."
        extracted_address = extract_address(text)
        assert extracted_address == 'The meeting is at 456 Vijan Bussiness Hotel, Jabalpur, WA 482005'
